            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Add New Client</h2>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('platform') is-invalid @enderror"
                                            id="platform" name="platform" value="{{ old('platform') }}" maxlength="50">
                                        @error('platform')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('reference_by') is-invalid @enderror"
                                            id="reference_by" name="reference_by" value="{{ old('reference_by') }}"
                                            placeholder="">
                                        @error('reference_by')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('tagline') is-invalid @enderror"
                                            id="tagline" name="tagline" value="{{ old('tagline') }}" maxlength="50">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea
                                            ...
                                            name="profile_description">{{ old('profile_description') }}</textarea>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-check mt-1">
                                            <input class="form-check-input" type="checkbox" name="show_city" id="show_city"
                                                value="1" {{ old('show_city') ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-check mt-1">
                                            <input class="form-check-input" type="checkbox" name="show_country"
                                                id="show_country" value="1" {{ old('show_country') ? 'checked' : '' }}>
